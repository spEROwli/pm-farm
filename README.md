...
15 test groups (175 checks) cover title and seniority filtering, deduplication, location classification, experience parsing, dead-link validation, Bright Data HTML parsing, and output rendering.
